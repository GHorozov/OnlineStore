describe('RenderContext', function() {
  ...
  it('renders each with a collection', function(done) {
    listenToChanged(app, {
      setup: function() {
        context.load('fixtures/list.html')
               .replace('#main')
               .renderEach('fixtures/item.template', 'myItem.hbs', [{'name': 'first'}, {'name': 'second'}])
               .appendTo('#main ul');
      },
      onChange: evaluateSecondCall(function() {
  ...
  it('renders each with a callback', function(done) {
    context.load('fixtures/list.html')
           .replace('#main')
           .renderEach('fixtures/item.template', 'myItem.hbs', [{'name': 'first'}, {'name': 'second'}], function(object, template) {
    ...
    listenToChanged(app, {
      setup: function() {
        context.render(function() {
          ...
          this.replace('#main');
          this.renderEach('fixtures/item.template', 'myItem.hbs', [{'name': 'first'}, {'name': 'second'}]);
